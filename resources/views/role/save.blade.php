...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Creaer permiso de administrador</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ url('role') }}">Permisos</a>
                </li>
            ...
            <form action="{{route('role.store')}}" method="post" id="roleForm">
                ...
                <div class="row restaurant_payout_create">
                    <div class="restaurant_payout_create-inner">
                        <fieldset>
                            <legend>Detalles del permiso</legend>
                            <div class="form-group row width-100 d-flex">
                                ...
                                <div class="col-6 text-right">
                                    <label for="permissions"
                                        class="form-label">Asignar permisos</label>
                                    <div class="text-right">
                                        <input type="checkbox" name="all_permission" id="all_permission">
                                        <label class="control-label"
                                            for="all_permission">Todos los permisos</label>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <table class="table table-striped">
                                            ...
                                            --}}
                                                <tr>
                                                    <td>
                                                        <strong>Roles del personal</strong>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <strong>Administradores Ikam</strong>
                                                    </td>
                                                    <td>
